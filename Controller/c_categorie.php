...
if(is_numeric($quantity)){
		...
		if($exist == true){
			...
			}else if($basket[$a]['quantity']> 10&& $unite!="piece"){
				$basket[$a]['quantity'] = 10;
				$basket[$a]['price_tot'] = 10*$price_prod;
				$message = $message."Quantité maximum est de 10, Vous ne pouvez pas en commander plus</br>";
			}else{
